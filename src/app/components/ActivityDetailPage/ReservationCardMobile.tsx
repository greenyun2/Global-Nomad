  ...
  const tileClassName = ({ date, view }: { date: Date; view: string }) => {
    ...
    if (view === "month") {
      if (isSelected) {
        ...
        return "react-calendar__tile--hasScedule"; // Add 'active' class to these dates
      }
    }
    return null;
  };
      ...
      {isLoginUserData?.id !== userId && (
        <div className="fixed inset-0 z-40 bg-white">
          <form
            ...
            className="border-gray-300pb-[1.125rem] mt-[1px] flex h-full flex-col gap-4 rounded-xl border border-solid shadow-[0_0.25rem_1rem_0_#1122110D]"
          >
            <section className="flex flex-col gap-4">
              {/* 인당 가격 표시 */}
              <div className="mt-[12px] hidden w-full pl-[1.028125rem] md:block">
              ...
              <div className="flex md:justify-center">
                <div className="flex w-full flex-col gap-4 border-t border-solid border-gray-300 px-6 pt-4">
            ...
            <section className="flex h-[21.25rem] w-full flex-col items-start gap-[1.5rem] px-6">
              <div className="w-full">
                {/* 약 스케쥴 버튼 */}
                <div className="mt-[30px] flex w-full flex-col gap-[0.875rem] border-b border-solid border-gray-300 pb-4">
            ...
            <section className="mb-[30px] mt-auto px-6">
              <Button
                disabled={isDisabled}
                type="submit"
                size="lg"
